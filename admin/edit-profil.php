            ...
            <div class="col-lg-12 mx-auto ">
                <div class="card mt-2 mx-auto bg-dark-gray">
                    <div class="card-body bg-dark-gray">
                        <div class = "container">
                            <form id="contact-form" role="form" action="<?= ROOT_URL ?>admin/edit-profil-logic.php" method="POST" enctype="multipart/form-data">
                                <div class="controls">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 pb-4">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" name="email" class="form-control" placeholder="Votre email" value="<?= $user['email'] ?>">
                                            </div>
                                        </div>
