        ...
        <div class="col-lg-8 col-sm-10 text-center d-flex flex-column m-auto">
            ...
            <form action="<?= ROOT_URL ?>admin/edit-post-logic.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control w-100" name="title" placeholder="Titre" value="<?= $post['title'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control h-25" rows="5" placeholder="Article de blog" name="body"><?= $post['body'] ?></textarea>
                </div>
                <div class="mb-3">
